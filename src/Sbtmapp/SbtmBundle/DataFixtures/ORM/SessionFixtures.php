...
class SessionFixtures extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $session1->setSessionName('A testing session');
        $session1->setStatusId('1');
        ...
        $session1->setProjectId('2');
        $session1->setCreated(new \DateTime());
        $session1->setUpdated($session1->getCreated());
        $manager->persist($session1);

        $session2 = new Session();
        $session2->setSessionName('A testing session');
        $session2->setStatusId('1');
        ...
        $session3->setSessionName('A testing session');
        $session3->setStatusId('1');
        ...
        $session4->setSessionName('A testing session');
        $session4->setStatusId('1');
        ...
        $session5->setSessionName('A testing session');
        $session5->setStatusId('1');
        ...
        $session6->setSessionName('A testing session');
        $session6->setStatusId('1');
        ...
        $session7->setSessionName('A testing session');
        $session7->setStatusId('1');
